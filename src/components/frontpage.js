...
<div id="frontpage-wrap">
    ...
    <Link key="im1" to="/product?category=0&subcategory=Vanteet&id=echohoop"><img id="image1" className="img-commercial" alt="commercial" src='/frontpagepics/c1.jpg'></img></Link>
    ...
    <Link key="im6" to="/product?category=0&subcategory=Vanteet&id=echohoop"><img className="img-commercial" alt="commercial" src='/frontpagepics/c1.jpg'></img></Link>
